...
class WeaponUpgradeModule:
    ...
    def open_inventory_and_sort(self):
        ...
        # 2. 点击左下角排序按钮
        if not self._wait_and_click('app/presentation/resources/images/upgrade/排序.png', 'image', self._roi(0, 616, 175, 147)):
            return False
        ...
        # 4. 点击倒序图标
        self._wait_and_click('app/presentation/resources/images/upgrade/排序倒序.png', 'image', self._roi(419, 203, 36, 30))
    ...
    def upgrade_loop(self):
        ...
        while True:
            ...
            mat_imgs = ["app/presentation/resources/images/upgrade/白材料.png", "app/presentation/resources/images/upgrade/绿材料.png", "app/presentation/resources/images/upgrade/蓝材料.png", "app/presentation/resources/images/upgrade/紫材料.png"]
            ...
            if self.auto.click_element('app/presentation/resources/images/upgrade/选择材料.png', 'image', crop=self._roi(828, 386, 193, 189), take_screenshot=False, is_log=self.is_log):
