...
class MassagingModule:
    ...
    def start_massaging(self):
        ...
        while True:
            ...
            if self.auto.click_element("app/presentation/resources/images/massaging/yellow_dot.png", "image",
            ...
            if self.auto.click_element("app/presentation/resources/images/massaging/red_dot.png", 'image',
                                       crop=(700 / 1920, 335 / 1080, 1688 / 1920, 832 / 1080), is_log=self.is_log,
                                       threshold=0.7):
                self.auto.key_down("space")
                time.sleep(8)
