...
class ShardExchangeModule:
    ...
    def swipe_to_base_puzzle(self):
        ...
        if self.auto.find_element('app/presentation/resources/images/jigsaw/base.png', 'image', crop=self._roi(0, 0, 95, 102), take_screenshot=True, is_log=self.is_log):
    ...
    def gift_shards(self):
        ...
        while True:
            ...
            if self.auto.find_element('app/presentation/resources/images/jigsaw/9_piece_present.png', 'image', crop=self._roi(495, 618, 567, 74), take_screenshot=False):
