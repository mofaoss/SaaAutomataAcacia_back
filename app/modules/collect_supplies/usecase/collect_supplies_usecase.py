...
from app.infrastructure.config.data_models import parse_config_update_data
from app.utils.network import get_cloudflare_data
    ...
    def friends_power(self):
        ...
        while True:
            ...
            if self.auto.click_element('键收赠', 'text', crop=(1722 / 1920, 1012 / 1080, 1858 / 1920, 1055 / 1080),
                                       is_log=self.is_log):
                continue
            # if self.auto.click_element("app/presentation/resources/images/collect_supplies/friends.png", "image",
    ...
    def receive_mail(self):
        ...
        while True:
            ...
            if self.auto.click_element('批量领取', 'text', crop=(303 / 1920, 982 / 1080, 462 / 1920, 1028 / 1080),
                ...
                click_flag = True
                continue
            # if self.auto.click_element('app/presentation/resources/images/collect_supplies/mail.png', 'image',
