...
class CapturePalsModule:
    ...
    def __init__(self, auto, logger):
        ...
        # ===== collect =====
        self.collect_image = "app/presentation/resources/images/fishing/collect.png"
        self.collect_crop = (1506 / 1920, 684 / 1080, 1547 / 1920, 731 / 1080)
        self.collect_threshold = 0.65

        # ===== exit map =====
        self.btn_exit_map_image = "app/presentation/resources/images/capture_pals/exit_map.png"
        self.btn_exit_map_crop = (1838 / 1920, 968 / 1080, 1870 / 1920, 1006 / 1080)
        self.btn_exit_map_threshold = 0.5

        self.btn_exit_confirm_image = "app/presentation/resources/images/capture_pals/exit_confirm.png"
        self.btn_exit_confirm_crop = (1371 / 1920, 740 / 1080, 1421 / 1920, 787 / 1080)

        # ===== island select =====
        self.partner_island_image = "app/presentation/resources/images/capture_pals/partner_island.png"
        self.adventure_island_image = "app/presentation/resources/images/capture_pals/adventure_island.png"
        ...
        # ===== in-map task icon =====
        self.in_map_task_image = "app/presentation/resources/images/capture_pals/in_map_task.png"
