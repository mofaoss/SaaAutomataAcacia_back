...
from app.utils.vision import count_color_blocks
...
class FishingModule:
    ...
    def select_lure(self):
        ...
        while True:
            ...
            # 选取鱼饵
            if not open_lure:
                self.auto.click_element('app/presentation/resources/images/fishing/select_lure.png', 'image',
    ...
    def after_fish(self):
        ...
        while True:
            ...
            #             "app/presentation/resources/images/fishing/new_record.png", "image", threshold=0.5,
    ...
    def is_spin_rod(self):
        ...
        """
        # self.auto.take_screenshot()
        if self.auto.find_element('app/presentation/resources/images/fishing/fish.png', 'image', threshold=0.6,
