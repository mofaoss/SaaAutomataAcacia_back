...
from app.infrastructure.config.app_config import config, isWin11, is_non_chinese_ui_language
from app.infrastructure.config.setting import QQ, REPO_URL
...
from app.presentation.widgets.slider_setting_card import SliderSettingCard
from app.presentation.widgets.text_edit_card import TextEditCard
from app.utils.updater import UpdateDownloadThread, get_best_update_candidate, get_local_version
...
class AboutHeaderWidget(QWidget, BaseInterface):
    ...
    def __init__(self, is_non_chinese_ui: bool = False, parent=None):
        ...
        pixmap = QPixmap("app/presentation/resources/images/sun.png")
